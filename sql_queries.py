...
TASK_3_QUERY = "SELECT COUNT(*) AS count FROM flights f1 JOIN airports a1 ON f1.departure_airport = a1.airport_code JOIN airports a2 ON f1.arrival_airport = a2.airport_code WHERE a1.timezone = a2.timezone"
#  count
# --------
#  16824
