...
TASK_3_QUERY = "SELECT COUNT(*) AS count FROM flights f JOIN Airports a1 ON f.departure_airport = a1.airport_code JOIN Airports a2 ON f.arrival_airport = a2.airport_code WHERE a1.timezone = a2.timezone"
#  count
# --------
#  16824
